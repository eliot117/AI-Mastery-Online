...
const ANIMEJS_LOGO = "data:image/svg+xml;base64,";
const ONEPAGE_LOGO = "data:image/svg+xml;base64,";
...
export const GALAXY_FOLDERS: Record<string, AITool[]> = {
  "Agents": [
    ...
    { id: 'a14', name: "Prompt Master", url: "https://claude.ai/chat/9fcc0bb7-a387-47e1-821a-ed788b2bd10a", description: "Expert Prompt Assistant", category: "Agents", icon: "P" },
  ...
  "Tasks": [
    ...
    { id: 't10', name: "AI Detector", url: "https://www.zerogpt.com/", description: "AI Text Checker", category: "Tasks", icon: "A" },
  ...
  "Inspirations": [
    ...
    { id: 'i7', name: "Aura", url: "https://www.aura.build/create", description: "Beautiful Designs", category: "Inspirations", icon: "A" },
